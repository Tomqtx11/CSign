...
//    descriptor.appearance = 0;
	NSInteger style =
		[NSUserDefaults.standardUserDefaults integerForKey:@"CSign.userInterfaceStyle"];
	NSInteger variant =
		[NSUserDefaults.standardUserDefaults integerForKey:@"CSign.shouldTintIcons"];
	NSInteger lightDark =
		[NSUserDefaults.standardUserDefaults integerForKey:@"CSign.shouldChangeIconsBasedOffStyle"];
...
static CGColorRef FRCreateCGColorFromHex(void) {
	NSString *hex =
		[NSUserDefaults.standardUserDefaults
			stringForKey:@"CSign.userTintColor"];
