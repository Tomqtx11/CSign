...
struct AppIconView: View {
	...
	var sections: [String: [AltIcon]] = [
		"Main": [
			AltIcon(displayName: "CSign", author: "Samara", key: nil),
			AltIcon(displayName: "CSign (macOS)", author: "Samara", key: "V2Mac"),
			AltIcon(displayName: "CSign v1", author: "Samara", key: "V1"),
			AltIcon(displayName: "CSign v1 (macOS)", author: "Samara", key: "V1Mac"),
			AltIcon(displayName: "CSign v0", author: "Samara", key: "V0"),
			AltIcon(displayName: "CSign Donor", author: "Samara", key: "Donor")
		],
		"Wingio": [
			AltIcon(displayName: "CSign", author: "Wingio", key: "Wing"),
		]
	]
