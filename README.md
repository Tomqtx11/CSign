[![GitHub Release](https://img.shields.io/github/v/release/claration/CSign?include_prereleases)](https://github.com/claration/CSign/releases)
[![GitHub Downloads (all assets, all releases)](https://img.shields.io/github/downloads/claration/CSign/total)](https://github.com/claration/CSign/releases)
[![GitHub License](https://img.shields.io/github/license/claration/CSign?color=%23C96FAD)](https://github.com/claration/CSign/blob/main/LICENSE)
...
<img title="CSign" alt="CSign" height="180" src=".github/landing.png">

Sideloading app meant for developer certificates.

<p align="center"><picture><source media="(prefers-color-scheme: dark)" srcset=".github/demo-dark.png"><source media="(prefers-color-scheme: light)" srcset=".github/demo-light.png"><img alt="CSign" src=".github/demo-light.png"></picture></p>
...
Visit [releases](https://github.com/claration/CSign/releases) and get the latest `.ipa`.

<a href="https://celloserenity.github.io/altdirect/?url=https://raw.githubusercontent.com/claration/CSign/refs/heads/main/app-repo.json" target="_blank">
   <img src="https://github.com/CelloSerenity/altdirect/blob/main/assets/png/AltSource_Blue.png?raw=true" alt="Add AltSource" width="200">
</a>
<a href="https://github.com/claration/CSign/releases/latest/download/CSign.ipa" target="_blank">
   <img src="https://github.com/CelloSerenity/altdirect/blob/main/assets/png/Download_Blue.png?raw=true" alt="Download .ipa" width="200">
</a>

## Translating

Impactor now has translation support, all localizations are located in `CSign/Resources/Localizable.xcstrings`.
...
This project is licensed under the GPL-3.0 license. You can see the full details of the license [here](https://github.com/claration/CSign/blob/main/LICENSE). It's under this specific license because I wanted to make a project that is transparent to the user thats related to certificate paired sideloading, before this project there weren't any open source projects that filled in this gap.
