...
struct SettingsView: View {
	...
	private let _githubUrl = "https://github.com/claration/CSign"
...
extension SettingsView {
	...
	private func _makeGitHubIssueURL(url: String) -> String {
		...
		switch UserDefaults.standard.integer(forKey: "CSign.installationMethod") {
		case 0: // Server
			let serverMethod = UserDefaults.standard.integer(forKey: "CSign.serverMethod")
			let ipFix = UserDefaults.standard.bool(forKey: "CSign.ipFix")
